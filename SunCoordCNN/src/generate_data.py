...
total_bk = 10
total_cls = 4
dir_out = 'D:\Git\RepoMALEKWHAT\SunCoordCNN\data\dataset_reg'
...
sun = pygame.image.load("D:/Git/RepoMALEKWHAT/SunCoordCNN/data/images/sun64.png")
backs = [pygame.image.load(f"D:/Git/RepoMALEKWHAT/SunCoordCNN/data/images/back_{n}.png") for n in range(1, total_bk+1)]
